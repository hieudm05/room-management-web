            ...
            <div class="card shadow rounded-4 border-0">
                <div class="card-body text-center">
                    <form action="{{ route('profile.update.avatar') }}" method="POST" enctype="multipart/form-data" id="avatar-form">
                        ...
                        <input type="file" name="avatar" id="avatar-input" accept="image/*" style="display:none;" onchange="submitAvatarForm()">
        ...
        <div class="col-md-9">
            <div class="card shadow rounded-4 border-0">
                <div class="card-body p-4">
                    <h4 class="mb-4 text-primary fw-bold border-start border-4 border-primary ps-3">Cập nhật thông tin cá nhân</h4>
                    ...
                    <form action="{{ route('tenant.profile.update') }}" method="POST" novalidate>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                <label for="phone_number" class="form-label fw-semibold">Số điện thoại <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-4">
                            <label for="identity_number" class="form-label fw-semibold">Số CMND/CCCD <span class="text-danger">*</span></label>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="gender" id="gender"
                                    ...
                                    <option value="" disabled {{ old('gender', $tenant->gender) ? '' : 'selected' }}>-- Chọn giới tính --</option>
