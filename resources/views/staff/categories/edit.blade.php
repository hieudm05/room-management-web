...
@section('content')
    <div class="container mx-auto px-4 py-10 max-w-7xl">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-8 animate__animated animate__fadeIn">
            <h2 class="text-3xl font-extrabold text-yellow-600 tracking-tight">
        ...
        <div class="bg-white rounded-xl shadow-md p-6 animate__animated animate__fadeInUp">
            <form method="POST" action="{{ route('staff.categories.update', $category->category_id) }}">
                @csrf
                @method('PUT')
                ...
                <button type="submit"
                    ...
                    <i class="bi bi-save me-2"></i>Cập nhật danh mục
                </button>
            </form>
        </div>
    </div>
