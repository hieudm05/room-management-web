                                    ...
                                    <form action="{{ route('landlords.staff.payment.store', $item['room_id']) }}"
                                       ...
                                       @if ($item['bill']->status == 'unpaid') border-warning shadow-sm @endif"
                                        ...
                                        <div class="form-section">
                                            ...
                                            @if ($item['is_bill_locked'])
                                                <p class="locked-message">Hóa đơn đã được lưu, không thể chỉnh sửa thông
                                                    tin
                                                    điện.</p>
                                            @endif
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control electric-price-display"
                                                        value="{{ number_format($item['electric_price'] ?? 3000) }}"
                                                        readonly>
                                                </div>
                                                <div class="col-md-3">
                                       ...
                                       <div class="form-section">
                                            ...
                                            @if (!empty($item['services']))
                                                    ...
                                                    <tbody>
                                                        @foreach ($item['services'] as $index => $service)
                                                            <tr>
                                                                <td>
                                                                    {{ $service['name'] }}
                                                                    <input type="hidden" name="data[services][{{ $index }}][name]" value="{{ $service['name'] }}">
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    {{ $service['total'] == 0 ? 'Miễn phí' : number_format($service['total']) }}
                                                                    <input type="hidden" name="data[services][{{ $index }}][total]" value="{{ $service['total'] }}">
                                                                </td>
                                                                <td>
                                                                    {{ $service['type_display'] }}
                                                                    <input type="hidden" name="data[services][{{ $index }}][type_display]" value="{{ $service['type_display'] }}">
                                                                </td>
                                                ...
                                                <div class="text-end">
                                                    <strong>Tổng tiền dịch vụ:
                                                        <span class="service-total">{{ number_format($item['service_total']) }}</span> VND
                                                    </strong>
                                                </div>
                                            @else
                                                ...
                                                @foreach ($item['additional_fees'] as $index => $fee)
                                                    <div class="row additional-fee-row">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="number"
                                                                class="form-control additional-fee-price"
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <input type="text"
                                                                class="form-control additional-fee-total"
                                                                name="data[additional_fees][{{ $index }}][total]"
                                                                value="{{ $fee['total'] ?? '' }}" readonly>
                                                        </div>
                                                        <div class="col-md-1">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control total"
                                                        ...
                                                        value="{{ number_format($item['total'], 0, ',', '.') }}đ"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
