...
<div class="container mt-4">
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            {{-- Form upload chỉ hiển thị khi chưa có ảnh --}}
            @if($deposits->isEmpty())
            <form action="{{ route('landlords.staff.deposit.upload', $room->room_id) }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card shadow-sm h-100">
                            <img src="{{ $deposit->image_url }}" class="card-img-top" alt="Deposit image">
            ...
            {{-- Quay lại --}}
            <div class="mt-4">
                <a href="{{ route('landlords.staff.show', $room->room_id) }}" class="btn btn-secondary">
                    🔙 Quay lại
                </a>
            </div>
        </div>
