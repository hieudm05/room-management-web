...
<div class="container mt-5">
    <h2 class="mb-4 text-danger">🔧 Xử lý khiếu nại do chủ xử lý{{ $complaint->id }}</h2>
    ...
    {{-- Form xử lý --}}
    <form action="{{ route('landlord.complaints.resolve', $complaint->id) }}"
          method="POST"
        ...
        <div class="card-footer d-flex justify-content-between">
            <a href="{{ route('landlord.complaints.index') }}" class="btn btn-outline-secondary">
                ⬅ Quay lại danh sách
            </a>
