                                    ...
                                    <div class="d-flex justify-content-center gap-1">
                                        ...
                                        @if ($c->status === 'pending')
                                            @if ($c->room->staffs->isEmpty())
                                                {{-- Chủ tự xử lý --}}
                                                <a href="{{ route('landlord.complaints.resolve.form', $c->id) }}" class="btn btn-sm btn-outline-primary">✍</a>
                                                <a href="{{ route('landlord.complaints.reject.form', $c->id) }}" class="btn btn-sm btn-outline-danger">❌</a>
                                            @else
