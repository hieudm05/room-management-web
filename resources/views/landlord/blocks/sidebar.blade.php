            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarProperty">
                    <ul class="nav nav-sm flex-column">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('landlords.rooms.index') }}" class="nav-link">Danh sách Phòng Tổng
                                Quan</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('landlords.approvals.users.index') }}" class="nav-link">Phê Duyệt Người
                                Dùng</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('landlords.room_edit_requests.index') }}" class="nav-link">Phê duyệt yêu
                                cầu chuyển phòng</a>
                        </li>
                        <li class="nav-item">
...
@if ($user->role === 'Landlord')
    ...
    <li class="nav-item">
        <a class="nav-link menu-link" href="#sidebarRoom" data-bs-toggle="collapse" role="button" aria-expanded="false"
        ...
        <div class="collapse menu-dropdown" id="sidebarLeaveRoom">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item"><a href="{{ route('landlord.roomleave.index') }}" class="nav-link">Yêu cầu
                        rời phòng</a></li>
                <li class="nav-item"><a href="{{ route('landlord.roomleave.processed') }}" class="nav-link">Lịch
                        sử duyệt</a></li>
            </ul>
        </div>
    </li>
    ...
    <!-- Ngân hàng -->
    <li class="nav-item">
        <a class="nav-link menu-link" href="#sidebarBank" data-bs-toggle="collapse" role="button" aria-expanded="false"
            aria-controls="sidebarBank">
        ...
        <div class="collapse menu-dropdown" id="sidebarBank">
            <ul class="nav nav-sm flex-column">
                ...
                <div class="collapse menu-dropdown" id="sidebarRoom">
                    <ul class="nav nav-sm flex-column">
                        @if ($user->role === 'Landlord')
                            <li class="nav-item"><a href="{{ route('landlords.rooms.index') }}" class="nav-link">Danh
                                    sách phòng</a></li>
                            <li class="nav-item"><a href="{{ route('landlords.services.index') }}"
                                    class="nav-link">Danh
                                    sách dịch vụ</a></li>
                            <li class="nav-item"><a href="{{ route('landlords.facilities.index') }}"
                                    class="nav-link">Danh sách tiện nghi</a></li>
                        @endif

                        @if ($user->role === 'Staff')
                            <li class="nav-item"><a href="{{ route('landlords.staff.index') }}" class="nav-link">Quản
                                    lý
                            ...
                            <li class="nav-item"><a href="{{ route('staff.posts.index') }}" class="nav-link">Đăng
                                    bài</a></li>
    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarApprovals">
            <ul class="nav nav-sm flex-column">
                ...
                <li class="nav-item">
                    <a href="{{ route('landlords.room_edit_requests.index') }}" class="nav-link">Yêu cầu chỉnh
                        sửa phòng</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('landlord.posts.approval.index') }}" class="nav-link">Duyệt bài đăng</a>
    ...
    <div class="collapse menu-dropdown" id="sidebarPost">
        <ul class="nav nav-sm flex-column">
            ...
            @if ($user->role === 'Landlord')
                ...
                <li class="nav-item">
                    <a href="{{ route('landlord.posts.approval.index') }}" class="nav-link">Duyệt bài
                        đăng</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('staff.posts.index') }}" class="nav-link">Đăng bài</a>
...
@if ($user->role === 'Landlord')
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarBank">
            <ul class="nav nav-sm flex-column">
                ...
                <li class="nav-item"><a href="{{ route('landlords.bank_accounts.index') }}" class="nav-link">Tất Cả
                        Tài Khoản</a></li>
                <li class="nav-item"><a href="{{ route('landlords.bank_accounts.assign') }}" class="nav-link">Phân
                        công cho tài sản</a></li>
            </ul>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarStaff">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item"><a href="{{ route('landlords.staff_accounts.index') }}" class="nav-link">Tất cả
    ...
    <!-- Hóa đơn -->
    <li class="nav-item">
        <a class="nav-link menu-link" href="#billsC" data-bs-toggle="collapse" role="button" aria-expanded="false"
            aria-controls="billsC">
            <i class="mdi mdi-file-document-outline"></i>
    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarComplaints">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item"><a href="{{ route('landlord.complaints.index') }}" class="nav-link">Danh sách
                        khiếu nại</a></li>
            </ul>
        </div>
    </li>
...
@if ($user->role === 'Staff')
    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarPostStaff">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item"><a href="{{ route('staff.posts.index') }}" class="nav-link">Danh sách
                        bài viết</a></li>
                <li class="nav-item"><a href="{{ route('staff.categories.index') }}" class="nav-link">Danh
                        mục bài đăng</a></li>
            </ul>
        </div>
    </li>
    ...
    <!-- Khiếu nại -->
    <li class="nav-item">
        <a class="nav-link menu-link" href="#sidebarComplaintsStaff" data-bs-toggle="collapse" role="button"
            aria-expanded="false" aria-controls="sidebarComplaintsStaff">
            <i class="mdi mdi-alert-circle-outline"></i>
            <span data-key="t-complaints">Khiếu nại</span>
        </a>
        <div class="collapse menu-dropdown" id="sidebarComplaintsStaff">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item"><a href="{{ route('landlord.staff.complaints.index') }}" class="nav-link">Tiếp
                        nhận khiếu nại</a></li>
                <li class="nav-item"><a href="{{ route('landlord.staff.complaints.history') }}"
                        class="nav-link">Lịch sử xử lý khiếu nại</a></li>
            </ul>
...
@if ($user->role === 'Staff')
    ...
    <li class="nav-item">
        <a class="nav-link menu-link" href="#bills" data-bs-toggle="collapse" role="button" aria-expanded="false"
            aria-controls="bills">
        ...
        <div class="collapse menu-dropdown" id="bills">
            <ul class="nav nav-sm flex-column">
                ...
                <li class="nav-item"><a href="{{ route('landlords.staff.payment.list') }}" class="nav-link">Danh
                        sách hoá đơn</a></li>
            </ul>
        </div>
    </li>
...
@if ($user->role === 'Landlord')
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="billsC">
            ...
            <ul class="nav nav-sm flex-column">
                <li class="nav-item"><a href="{{ route('landlords.payment.list') }}" class="nav-link">Nhập
                        hoá đơn</a></li>
            </ul>
    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarBooking">
            <ul class="nav nav-sm flex-column">
                @if ($user->role === 'Landlord')
                    <li class="nav-item">
                        <a href="{{ route('landlord.bookings.index') }}" class="nav-link">Quản lý đặt
                            lịch</a>
                    </li>
                @endif
            </ul>
    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarBookingStaff">
            <ul class="nav nav-sm flex-column">
                ...
                <li class="nav-item"><a href="{{ route('booking.index') }}" class="nav-link">Quản lý đặt
                        lịch</a></li>
                <li class="nav-item"><a href="{{ route('landlord.staff.chart.index') }}" class="nav-link">Biểu đồ
                        đặt lịch</a></li>
                <li class="nav-item"><a href="{{ route('staff.contract.renewals.index') }}" class="nav-link">Tiếp
                        nhận tái ký</a></li>
                <li class="nav-item"><a href="{{ route('landlord.staff.roomleave.index') }}" class="nav-link">Quản
                        lý yêu cầu rời phòng</a></li>
                ...
                <li class="nav-item">
                    <a href="{{ route('staff.contract.renewals.index') }}" class="nav-link">Tiếp nhận tái
                        ký</a>
                </li>
                <li class="nav-item">
