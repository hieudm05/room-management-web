        ...
        @if ($user->role === 'Staff')
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarPostStaff">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item"><a href="{{ route('staff.posts.index') }}" class="nav-link">Danh sách bài
                                viết của bạn</a></li>
            ...
            @if ($user->role === 'Landlord')
                ...
                <li class="nav-item"><a href="{{ route('landlords.approvals.index') }}" class="nav-link">Quản Lý
                        Phê Duyệt Hợp Đồng</a></li>
                <li class="nav-item"><a href="{{ route('landlords.approvals.users.index') }}" class="nav-link">Quản
                        Lý Phê Duyệt Người Dùng</a></li>
                <li class="nav-item"><a href="{{ route('landlords.room_edit_requests.index') }}"
                        class="nav-link">Phê duyệt yêu cầu chuyển phòng</a></li>
                <li class="nav-item"><a href="{{ route('landlord.posts.approval.index') }}" class="nav-link">Duyệt
                        bài đăng</a></li>
