...
<div class="container-fluid">
    ...
    <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link menu-link" href="#sidebarRoom" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarRoom">
            ...
            <div class="collapse menu-dropdown" id="sidebarRoom">
                <ul class="nav nav-sm flex-column">
                    @if ($user->role === 'Landlord')
                        <li class="nav-item"><a href="{{ route('landlords.properties.list') }}" class="nav-link">Quản Lý Bất Động Sản</a></li>
                        ...
                        <li class="nav-item"><a href="{{ route('landlord.posts.approval.index') }}" class="nav-link">Duyệt bài đăng</a></li>
                    @endif
        ...
        @if ($user->role === 'Landlord')
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarBank">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item"><a href="{{ route('landlords.bank_accounts.index') }}" class="nav-link">Tất Cả Tài Khoản</a></li>
                        <li class="nav-item"><a href="{{ route('landlords.bank_accounts.assign') }}" class="nav-link">Phân công cho tài sản</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarStaff">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item"><a href="{{ route('landlords.staff_accounts.index') }}" class="nav-link">Tất cả tài khoản nhân viên</a></li>
                    </ul>
                </div>
            </li>
        @endif
        ...
        @if ($user->role === 'Staff')
            <li class="nav-item">
                <a class="nav-link menu-link" href="#bills" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="bills">
                    <i class="mdi mdi-receipt"></i>
                    <span data-key="t-bank">Hoá đơn</span>
                </a>
                <div class="collapse menu-dropdown" id="bills">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item"><a href="{{ route('landlords.staff.payment.index') }}" class="nav-link">Danh sách hoá đơn</a></li>
                    </ul>
                </div>
            </li>
        @endif
        ...
        @if ($user->role === 'Landlord')
            <li class="nav-item">
                <a class="nav-link menu-link" href="#billsC" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="billsC">
                    <i class="mdi mdi-file-document-outline"></i>
                    <span data-key="t-bank">Hoá đơn (chủ)</span>
                </a>
                <div class="collapse menu-dropdown" id="billsC">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item"><a href="{{ route('landlords.bills.index') }}" class="nav-link">Danh sách hoá đơn</a></li>
                    </ul>
                </div>
            </li>
        @endif
