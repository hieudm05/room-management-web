        ...
        @if ($user->role === 'Landlord')
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarBank">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('landlords.bank_accounts.index') }}" class="nav-link">Tất Cả Tài
                                Khoản</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('landlords.bank_accounts.assign') }}" class="nav-link">Phân công cho
                                tài sản</a>
                        </li>
                    </ul>
                </div>
        ...
        @if ($user->role === 'Landlord' || $user->role === 'Staff')
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarStaff">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('landlords.staff_accounts.index') }}" class="nav-link">Tất cả tài khoản
                                nhân viên</a>
                        </li>
                        @if ($user->role === 'Landlord')
                            <li class="nav-item">
                                <a href="{{ route('landlords.properties.list') }}" class="nav-link">Danh sách Bất
                                    Động Sản</a>
                            </li>
                        @endif
                    </ul>
        ...
        @if ($user->role === 'Staff')
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarComplaintsStaff">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('landlord.staff.complaints.index') }}" class="nav-link">Tiếp nhận khiếu
                                nại</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('landlord.staff.complaints.history') }}" class="nav-link">Lịch sử xử lý
                                khiếu nại</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarBookingStaff">
                    <ul class="nav nav-sm flex-column">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('landlord.staff.roomleave.index') }}" class="nav-link">Quản lý yêu cầu
                                rời sửa phòng</a>
                        </li>
                    </ul>
                </div>
