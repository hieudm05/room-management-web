        ...
        @if ($user->role === 'Landlord')
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarComplaints">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item"><a href="{{ route('landlord.complaints.index') }}"
                                class="nav-link">Danh sách khiếu nại</a></li>
                    </ul>
                </div>
            </li>
        @endif
                ...
                <div class="collapse menu-dropdown" id="sidebarBookingStaff">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item"><a href="{{ route('booking.index') }}" class="nav-link">Quản lý đặt
                                lịch</a></li>
                        <li class="nav-item"><a href="{{ route('landlord.staff.chart.index') }}"
                                class="nav-link">Biểu đồ đặt lịch</a></li>
                        <li class="nav-item"><a href="{{ route('staff.contract.renewals.index') }}"
                                class="nav-link">Tiếp nhận tái ký</a></li>
                        <li class="nav-item"><a href="{{ route('landlord.staff.roomleave.index') }}"
                                class="nav-link">Quản lý yêu cầu rời phòng</a></li>
                    </ul>
                </div>
            </li>
        @endif
