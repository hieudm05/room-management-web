    ...
    <div class="container">
        <div class="card shadow-sm">
            <div class="card-header bage-primary text-white d-flex justify-content-between align-items-center">
                ...
                <form id="filter-form" action="{{ route('landlords.payment.index') }}" method="GET" class="d-flex align-items-center">
                                    ...
                                    <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}"
                                        ...
                                        <div class="form-section">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <a href="{{ route('landlords.payment.exportExcel', [$item['room_id'], 'month' => $item['month']]) }}" class="btn btn-primary">
                                                    Xuất Excel
                                                </a>
                                            </div>
                                        </form>
