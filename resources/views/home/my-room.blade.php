                                        ...
                                        <div class="modal-content shadow-lg border-0">
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="col-md-6 text-center">
                                                        @if ($bill->bankAccount)
                                                            @php
                                                                ...
                                                                $accountNumber =
                                                                    $bill->bankAccount->bank_account_number;
                                                                $accountName = urlencode(
                                                                    $bill->bankAccount->bank_account_name,
                                                                );
                                                ...
                                                <form action="{{ route('bills.markPending', $bill->id) }}" method="POST"
                                                    ...
                                                    @csrf
                                                    <input type="datetime-local" id="payment_time_{{ $bill->id }}"
                                                        hidden name="payment_time" class="form-control" required>
                                                    <div class="col-md-12 mb-3">
                                                        <label for="receipt_image_{{ $bill->id }}"
                                                            class="form-label">📎 Ảnh chụp biên lai</label>
                                                        <input type="file" id="receipt_image_{{ $bill->id }}"
                                                            name="receipt_image" class="form-control" accept="image/*"
                                                            required>
                                                    </div>
                                                    <div class="text-end">
                                        ...
                                        <div class="modal-content border-0 rounded-4 shadow-lg overflow-hidden">
                                            ...
                                            <div class="modal-body p-4 bg-light">
                                                <div class="row g-4">
                                                    <div class="col-md-6">
                                                        <div
                                                            class="p-4 bg-white rounded-4 shadow-sm h-100 border border-light-subtle">
                                                            ...
                                                            @foreach ($items as $label => $value)
                                                                <div
                                                                    class="d-flex justify-content-between border-bottom border-dashed py-2">
                                                                    <span>{{ $label }}</span>
                                                                    <span
                                                                        class="fw-semibold text-dark">{{ number_format($value ?? 0) }}
                                                                        đ</span>
                                                                </div>
                                                            @endforeach

                                                            <div
                                                                class="d-flex justify-content-between border-top pt-3 mt-3">
                                                                    ...
                                                                    <div class="row">
                                                                        @foreach ($bill->utilityPhotos as $photo)
                                                                            <div class="col-md-6 mt-2">
                                                                                <div
                                                                                    class="ratio ratio-4x3 rounded border shadow-sm overflow-hidden">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div
                                                            ...
                                                            <p class="mb-2"><strong>Ngày
                                                                    tạo:</strong><br>{{ $bill->created_at->format('d/m/Y H:i') }}
                                                            </p>
                                                            <p class="mb-2"><strong>Trạng thái:</strong><br>
                                                                ...
                                                                @endphp
                                                                <span
                                                                    class="badge {{ $status[1] }} rounded-pill px-3 py-2">{{ $status[0] }}</span>
                                                            </p>

                                                            @if ($bill->payment_time)
                                                                <p class="mb-2"><strong>🕒 Thời gian
                                                                        TT:</strong><br>{{ \Carbon\Carbon::parse($bill->payment_time)->format('d/m/Y H:i') }}
                                                                </p>
                                                            @endif
                                                            ...
                                                            @if ($bill->receipt_image)
                                                                <div class="mt-4">
                                                                    ...
                                                                    <div
                                                                        class="ratio ratio-4x3 rounded border shadow-sm mt-2 overflow-hidden">
                                                            ...
                                                            @else
                                                                <p class="text-muted mt-4">⚠️ Chưa có biên lai thanh toán.
                                                                </p>
                                                            @endif
                                                        </div>
                                                    </div>
